...
export default function FAQAndCTA() {
  ...
  return (
    <>
      <section
        id="faq"
        className="scroll-mt-32 bg-[#070707] py-24 text-[#F4EFE6] md:scroll-mt-36 md:py-32"
      >
        <div className="mx-auto grid max-w-6xl gap-14 px-6 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="text-4xl font-black uppercase leading-[0.92] tracking-tighter md:text-7xl">
              Clear answers.{" "}
              <span className="text-white/20">Easy next steps.</span>
            </h2>
            <p className="mt-6 max-w-md text-sm font-medium leading-relaxed text-white/42">
                ...
                <div key={faq.question}>
                  ...
                  <AnimatePresence initial={false}>
                    {open && (
                      ...
                      >
                        <p className="max-w-2xl pb-6 text-sm font-medium leading-relaxed text-white/48">
                          {faq.answer}
                        </p>
                      </motion.div>
                    )}
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          >
            Get My Store Plan <ArrowUpRight size={16} />
          </button>
