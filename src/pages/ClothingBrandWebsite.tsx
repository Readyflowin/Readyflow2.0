...
export const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Readyflow's focused Instagram Brand Shopify Launch is a one-time ₹11,999 setup fee. Shopify, a domain, optional paid themes or apps, payment processing, shipping, photography, and advanced custom work are separate.",
  },
  {
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-5 py-14 sm:px-6 lg:grid-cols-[190px_minmax(0,760px)] lg:justify-center">
        ...
        <div className="min-w-0">
          ...
          <div className="editorial-copy">
            ...
            <p>Readyflow helps Instagram-first product brands launch that layer through the ₹11,999 Instagram Brand Shopify Launch. This guide focuses on what makes a <strong>clothing ecommerce website</strong> genuinely useful for the people browsing it.</p>
